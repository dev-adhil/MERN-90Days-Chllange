...
API_KEY = "AIzaSyCPexwCGxT8ugOKsmowtLWADBK4BaX9q5s";
...
const generateBotResponse = async (incomingMessageDiv) => {
  ...
  try {
    ...
    // 🧹 Reset file data and scroll chat
    userData.file = {};
...
const messageContent = ` <div class="message-text"></div>
  ...
  // simulaate bot response with thinking indicator after a delay
  setTimeout(()=>{
